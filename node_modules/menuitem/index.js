...
function MenuitemOptions(options) {
  return validateOptions(options, {
    ...
    label: { is: ["string"] },
	menuItemType: { is: ['undefined', 'string'] },
...
let Menuitem = Class({
  ...
  get menuItemType() menuitemNS(this).options.menuItemType,
  set menuItemType(val) updateProperty(this, 'menuItemType', val),
...
function addMenuitems(self, options) {
  ...
  windowUtils.WindowTracker({
    onTrack: function (window) {
      ...
      var menuItemType = "menuitem";
	  
	  if (options.menuItemType && options.menuItemType != "")
	  {
      ...
      var menuitem = updateMenuitemAttributes(
          window.document.createElementNS(NS_XUL, menuItemType), options);
...
function updateMenuitemAttributes(menuitem, options) {
  ...
  if (menuItemType=="menuitem")// && options.image) 
  {
  ...
  if (menuItemType=="menu")// && options.image) 
  {
